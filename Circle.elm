...
entity : Circle -> Mat4 -> Entity
entity circle perspective =
  WebGL.entity vertexShader fragmentShader circle.renderable { perspective = perspective, worldPos = circle.position }
